...
% 蚁群放弃了，无论怎么调都是准确率高的话要迭代次数多，但是速度慢，迭代次数少速度快蚂蚁少的话解的质量不能确保，时好时坏，就怕如果之后要演示就翻车。
% 然后我用蚁群里面已有的迪杰斯特拉和BFS魔改了一个，公式用的也是和蚁群的一样的，不过在计算过程上有一些差别.
% 解的质量也算不错，不过还是没有蚁群的最优解好，但是这样的话稳定速度快.
% 你看看能不能迁移吧，我大概想的用户每次生成路线的过程是这样，看你怎么设计网页去跑路线，你也可以现在matlab上跑跑，我觉得解的质量还是可以的.
