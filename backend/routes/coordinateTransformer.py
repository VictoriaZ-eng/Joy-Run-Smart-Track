# 百度坐标系统转换WGS84代码，配套百度街景爬取代码，未使用
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 4 23:48:00 2017
...
def bd09lltobd09mc(lon, lat):
	...
	x = cE[0] + cE[1] * abs(lon)
	cC = abs(lat) / cE[9]
	y = cE[2] + cE[3] * cC + cE[4] * cC ** 2 + cE[5] * cC ** 3 + cE[6] * cC ** 4 + cE[7] * cC ** 5 + cE[8] * cC ** 6
	x = x if lon >= 0 else -x
	y = y if lat >= 0 else -y
	return x, y
